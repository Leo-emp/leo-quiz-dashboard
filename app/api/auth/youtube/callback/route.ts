...
export async function GET(request: Request) {
  ...
  // Verify CSRF state token matches what we stored in the cookie
  ...
  try {
    ...
    // Get the channel name for display in settings
    ...
    // Save tokens to Vercel Blob (connect-once pattern)
